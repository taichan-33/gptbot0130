...
<style> div\[data-testid="stToolbar"\] { visibility: hidden; height: 0%; position: fixed; } div\[data-testid="stDecoration"\] { visibility: hidden; height: 0%; position: fixed; } </style>
"""
